...
env.info('Loading PROD DCS-TTS.lua')
STTS = {}
-- FULL Path to the FOLDER containing DCS-SR-ExternalAudio.exe - EDIT TO CORRECT FOLDER
-- STTS.DIRECTORY = "C:\\Program Files\\DCS-SimpleRadio-Standalone"
-- STTS.SRS_PORT = 5003 -- LOCAL SRS PORT - DEFAULT IS 5002

-- if DEV_MODE then
--     STTS.DIRECTORY = "G:\\DCS-SimpleRadio-Standalone"
--     STTS.SRS_PORT = 5002 -- LOCAL SRS PORT - DEFAULT IS 5002
-- else

-- end
-- C:\Program Files\DCS-SimpleRadio-Standalone\DCS-SR-ExternalAudio.exe
STTS.DIRECTORY = "C:\\Program Files\\DCS-SimpleRadio-Standalone"
STTS.SRS_PORT = 5003 -- LOCAL SRS PORT - DEFAULT IS 5002
